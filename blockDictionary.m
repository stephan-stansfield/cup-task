...
% duration.
%
% Note that blocks 3 & 4 for the 11 acceptable subjects correspond to
% blockNum 1-22. Blocks 3 & 4 for *all subjects* would be 1 to 28.
%
% Block 2 for the 11 acceptable subjects corresponds to blockNum 29-39.
% Block 2 for the rejected subjects are not included here.
...
function [subjNum, subjStr, trialDate, trialStr, blockStr, plotColor,...
        minVelOutliers, invalidTrials] = blockDictionary(blockNum)
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Below this line, subjects are excluded from analysis
