...
%     fitMethod = "fitToAverage";
    ...
    for setting = 1
        ...
        elseif setting == 3
            % 3. No impedance simplification, feedforward
            optimizationType = "input shaping 2 impulse impedance";
            ver         = "no impedance";
            timeMod     = false;
            ampMod      = false;
        ...
        elseif setting == 4
            % 4. Rigid body simplification, feedforward
            optimizationType = "input shaping 2 impulse impedance";
            ver         = "rigid body";
            timeMod     = false;
            ampMod      = false;
...
%         if ~plotInd
            ...
            for  blockNum = blockStart:1:blockEnd
                ...
                if plotInd
                    ...
                    numStart = (blockNum-1)*50 + 2;
                    numEnd = numStart + 49;
                end
                range = strcat("A",num2str(numStart),":",rangeEnd,num2str(numEnd));
