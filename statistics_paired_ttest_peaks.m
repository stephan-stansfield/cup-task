...
load("best fit simulation/peakRatioArrays.mat");      % load best-fit peak ratio data

n = 11;                     % number of subjects
nSim = 11;                  % number of simulations
difference = zeros(nSim,n); % difference between subject median peak ratios
...
for sim = 1:nSim
    difference(sim,:) = medianBySubject(sim+1,:) - medianBySubject(1,:); % compare each simulation type to human data
